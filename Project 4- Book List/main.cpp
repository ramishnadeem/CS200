...
void phase1_test2()
{
	...
	cout << book2.GetPurchaseStatus();
	cout << book2.GetReadingStatusString();
...
void phase1_test3()
{
	...
	cout << book3.GetReadingStatusString();
	cout << book3.GetReadingStatus();
}
